        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body" data-aos="fade-up">
              ...
              <i>
                <i className="primary-header">Technologies and Tech stacks.</i>
              </i>
              <br />
              <br />I always apply my experience in developing products with{" "}
              <i className="primary-header">Front end with AI </i> and modern AGI
              <i className="primary-header"> Artificial General Intelligence</i>
              <br />
              <br />
          ...
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links" data-aos="fade-up">
              <li className="social-icons">
                <a
                  href="https://github.com/naveens01"
                  target="_blank"
                  rel="noreferrer"
              ...
              <li className="social-icons">
                <a
                  href="mailto:naveens.ee20@bitsathy.ac.in"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                  aria-label="email"
              ...
              <li className="social-icons">
                <a
                  href="https://www.linkedin.com/in/naveen-s-172a10207/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                  aria-label="linkedin"
